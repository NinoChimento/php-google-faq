  ...
  <body>
    ...
    <main>
      <?php foreach ($db as $key => $value) {
        foreach ($value as $domanda => $rispsota) {?>
          <div class="questionario">
            <h2><?php echo $domanda; ?> </h2>
            <p> <?php echo $rispsota ?></p>
          </div>
        <?php }
      } ?>
    </main>
